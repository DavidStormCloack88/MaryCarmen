...
namespace ConsultaCompuesta4
{
    public class Tests
    {
        private ITrasladoInternoServicio _trasladoInternoServicio;
        ...
        public void Setup()
        {
            ...
            _trasladoInternoServicio = new TrasladoInternoServicioImpl(_MaryCarmenDBContext);
        }

        [Test]
        public async Task Test1()
        {
            var result = await _trasladoInternoServicio.listadetallefecha();
