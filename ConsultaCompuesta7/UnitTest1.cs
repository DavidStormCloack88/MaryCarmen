...
namespace ConsultaCompuesta7
{
    public class Tests
    {
        private IDetalleVentaServicio _detalleVentaServicio;
        ...
        public void Setup()
        {
            ...
            _detalleVentaServicio = new DetalleVentaServicioImpl(_MaryCarmenDBContext);
        }

        [Test]
        public async Task Test1()
        {
            var result = await _detalleVentaServicio.ListaPorDetalleVenta();
